...
>(({ class: classAstro, className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ref={ref}
      className={cn(toastVariants({ variant }), classAstro || className)}
      {...props}
    />
  )
})
...
>(({ class: classAstro, className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-semibold", classAstro || className)}
    {...props}
  />
))
...
const ToastDescription = React.forwardRef<
  ...
  Omit<React.ComponentPropsWithoutRef<typeof ToastPrimitives.Description>, 'className'> & {
    class?: string;
    className?: string;
  }
>(({ class: classAstro, className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-sm opacity-90", classAstro || className)}
    {...props}
  />
))
