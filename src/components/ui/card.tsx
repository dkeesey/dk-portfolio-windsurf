...
import type { DivProps } from '@/types/components';
...
const CardTitle = React.forwardRef<HTMLHeadingElement, DivProps>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
...
const CardDescription = React.forwardRef<HTMLParagraphElement, DivProps>(({ className, ...props }, ref) => (
  <p
    ref={ref}
